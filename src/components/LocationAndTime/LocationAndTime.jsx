...
const LocationAndTime = () => {
  return (
    <div className="bg-white min-w-[42rem] p-6 rounded">
          ...
          <div className="flex my-3 justify-between">
            <div className="min-w-full">
              ...
              <div className="flex gap-2 items-center">
                <Form.Item name="deliveryLocation" className="m-0 w-3/4">
                  <Input
                    placeholder="Add Location"
                    className="p-1 hover:border-orange-400 bg-gray-100 focus:border-orange-400"
                  />
                </Form.Item>
                <button className="bg-black text-white flex items-center gap-0.5 text-xs rounded p-1">
          ...
          <div className="flex justify-between">
            <div className="min-w-full">
              ...
              <div className="flex gap-2 items-center">
                <Form.Item name="returnLocation" className="m-0 w-3/4">
                  <Input
                    placeholder="Add Location"
                    className="p-1 hover:border-orange-400 bg-gray-100 focus:border-orange-400"
                  />
